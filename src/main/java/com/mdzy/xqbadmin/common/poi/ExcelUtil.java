...
//				Object rel = m.invoke(obj);
	 ...
	 * @return
	 */
	public List<Object> readExcel2ObjsByIo(InputStream in, Class clz, int readLine, int tailLine) {
		Workbook wb = null;
		try {
	 ...
	 * @return 对象列表
	 */
	public List<Object> readExcel2ObjsByIo(InputStream in, Class clz) {
		return this.readExcel2ObjsByIo(in, clz, 0,0);
	}
	/**
