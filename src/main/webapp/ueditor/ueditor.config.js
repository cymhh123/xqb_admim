...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://qiniuweb.beizhiyuan.com.cn/" //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置Todo
        //七牛结合需要改成file
        ...
        //图片在线管理配置区
        ,imageManagerUrl: "imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:"http://qiniuweb.beizhiyuan.com.cn/"//图片修正地址，同imagePathTodo
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'scrawl','map','insertcode', 'pagebreak', 'template', '|',
