            ...
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <div class="row m-b-sm m-t-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="input-sm form-control" v-on:keyup="getData(1)" placeholder="请输入用户名" v-model="search.userName">
                        </div>
                        <div class="col-sm-2">
                            <select class="form-control input-sm" v-model="search.payStatus" v-on:change="getData(1)">
                                <option value selected>请选择支付状态</option>
                                <c:forEach items="${fns:getDictList('pay_status')}" var="item">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tr v-for="item in list">
                                    <td>
                                        <i class="fa fa-user"></i><span data-toggle="tooltip" v-bind:title="item.userName">{{item.userName | substring 16}}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span data-toggle="tooltip" v-bind:title="item.info">{{item.info | substring 16}}</span>
                                    </td>
                                    <td>
                                        {{item.payStatusL}}
                                    </td>
        ...
        new Vue({
            ...
            methods: {
                getData: function (curr) {//提交数据
                    ...
                    $.getJSON("${ctx}/order/list", this.search, function (res) {
                        self.list = res.extra;
