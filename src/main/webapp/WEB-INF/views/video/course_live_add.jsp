        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form role="form" id="dataform" class="form-horizontal">
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><span class="c-red">*</span>直播时间：</label>
                        <div class="col-sm-10">
                            <input id="laydate" class="laydate-icon form-control layer-date" datatype="*" nullmsg="请选择时间！">
                            <span class="help-block has-error m-b-none Validform_checktip"> </span>
                        </div>
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><span class="c-red">*</span>推流地址：</label>
                        <div class="col-sm-10">
                            <input type="text" placeholder="请输入推流地址" v-model="entity.pushUrl"  class="form-control" datatype="*1-200" nullmsg="请输入推流地址！">
                            <span class="help-block has-error m-b-none Validform_checktip"> </span>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><span class="c-red">*</span>播放地址：</label>
                        <div class="col-sm-10">
                            <input type="text" placeholder="请输入播放地址" v-model="entity.playUrl"  class="form-control" datatype="*1-200" nullmsg="请输入播放地址！">
                            <span class="help-block has-error m-b-none Validform_checktip"> </span>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
