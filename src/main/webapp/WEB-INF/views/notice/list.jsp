            ...
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <div class="row m-b-sm m-t-sm">
                        ...
                        <div class="col-sm-2">
                            <select class="form-control input-sm" v-model="search.category" v-on:change="getData(1)">
        ...
        new Vue({
            ...
            methods: {
                getData: function (curr) {//提交数据
                    ...
                    $.getJSON("${ctx}/notice/list", this.search, function (res) {
                        self.list = res.extra;
                ...
                deleteData: function (index) {//删除元素
                    ...
                    $.post('${ctx}/notice/delete', {id: id}, function (res) {
                        if (res.code == '200') {
                            //更新列表
