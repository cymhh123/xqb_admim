            ...
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <div class="row m-b-sm m-t-sm">
                        <div class="col-sm-2">
                            <select class="form-control input-sm" v-model="search.flag" v-on:change="getData(1)">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tr v-for="item in list">
                                    ...
                                    <td>
                                        <span data-toggle="tooltip" v-bind:title="item.param">{{item.param | substring 16}}</span>
                                    </td>
                                    <td>
                                        <span class="badge badge-primary">{{item.flagL}}</span>
                                    </td>
        ...
        new Vue({
            ...
            methods: {
                getData: function (curr) {//提交数据
                    ...
                    $.getJSON("${ctx}/banner/list", this.search, function (res) {
                        self.list = res.extra;
                ...
                deleteData: function (index) {//删除元素
                    ...
                    $.post('${ctx}/banner/delete', {id: id}, function (res) {
                        if (res.code == '200') {
                            //更新列表
