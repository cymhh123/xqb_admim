                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tr v-for="item in list">
                                    ...
                                    <td>
                                        <span data-toggle="tooltip" v-bind:title="item.des">{{item.des | substring 16}}</span>
                                    </td>
        ...
        new Vue({
            ...
            methods: {
                getData: function (curr) {//提交数据
                    ...
                    $.getJSON("${ctx}/topic/list", this.search, function (res) {
                        self.list = res.extra;
                ...
                deleteData: function (index) {//删除元素
                    ...
                    $.post('${ctx}/topic/delete', {id: id}, function (res) {
                        if (res.code == '200') {
                            //更新列表
