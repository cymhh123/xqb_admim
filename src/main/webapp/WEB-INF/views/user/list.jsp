            ...
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <div class="row m-b-sm m-t-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="input-sm form-control" v-on:keyup="getData(1)" placeholder="请输入账号" v-model="search.account">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" class="input-sm form-control" v-on:keyup="getData(1)" placeholder="请输入昵称" v-model="search.nick">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" class="input-sm form-control" v-on:keyup="getData(1)" placeholder="请输入绑定手机号" v-model="search.phone">
                        </div>
                        <div class="col-sm-2">
        ...
        new Vue({
            ...
            methods: {
                getData: function (curr) {//提交数据
                    ...
                    $.getJSON("${ctx}/user/list", this.search, function (res) {
                        self.list = res.extra;
